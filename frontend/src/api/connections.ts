...
export async function initiateConnection(platform: ConnectionPlatform): Promise<InitiateConnectionResponse> {
  return postJson<InitiateConnectionResponse>(`/connections/${platform}/initiate`, {});
}

export async function completeConnection(platform: ConnectionPlatform): Promise<ConnectionCallbackResponse> {
